...
<head>
    ...
    <script type="text/javascript">
        function changeMajor() {
            ...
            window.location.href = 'insert.jsp?selectedMajor=' + encodeURIComponent(selectedMajor);
        }
    </script>
</head>
<body>
...
<table width="80%" align="center" border>
    ...
    <select id="majorSelect" onchange="changeMajor()">
        ...
        %>
        <option value="<%=major%>" <%=selectedMajor != null && selectedMajor.equals(major) ? "selected" : ""%>><%=major%></option>
        <%
            }
            ...
            mySQL = "select c_id,c_name,c_id_no,c_unit,c_max,c_app,c_major,c_wait,c_year,c_sem from course " +
                    "where c_year=" + currentYear + " and c_sem=" + currentSemester +
